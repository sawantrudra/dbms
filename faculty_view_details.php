...
<html>
  ...
  <input type="text" name="search" placeholder="Search..">
                 ...
                 <li>
                    <a href="faculty.php" class="btn btn">Faculty</a>
                </li>
                <li>
      ...
      <div class="content-wrapper">
        ...
        <div class="container-fluid" style="margin:20px;">
            ...
            <?php
    $sql = "SELECT * from Faculty where Faculty_id=".$_GET['fid'];
	$result = mysqli_query($db_connect,$sql);
                      $row = $result->fetch_assoc();
                     
                      echo '<h2>'.$row['Faculty_name'].'</h2>';
                      echo ' <table class="table table-striped">
    <tr><th>'.'Name'.'</th><td>'.$row['Faculty_name'].'</td></tr><tr><th>'.'Office No.'.'</th><td>'.$row['Faculty_office_phone'].'</td></tr><tr><th>'.'Mobile no.'.'</th><td>'.$row['Faculty_mobile_no'].'</td></tr><tr><th>'.'Email'.'</th><td>'.$row['Faculty_email'].'</td></tr><tr><th>'.'Gender'.'</th><td>'.$row['Gender'].'</td></tr><tr><th>'.'Birthdate'.'</th><td>'.$row['Birthdate'].'</td></tr>';
