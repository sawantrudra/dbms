...
<html>
  ...
  <input type="text" name="search" placeholder="Search..">
                ...
                <li>
                    <a href="../logout.php" class="btn btn">All Research papers</a>
                </li>
                <li>
                    <a href="../logout.php" class="btn btn">All Conferences</a>
                </li>
                <li>
                    <a href="../logout.php" class="btn btn ">All Workshops</a>
                </li>
      ...
      <div class="content-wrapper">
        ...
        <div class="container-fluid" style="margin:20px;">
          ...
          <div style="width: 100%;height: 1px;border-bottom: 1px solid #000; margin: 15px;"></div>
...
function updateDetails(){
  ...
  var ifsc = $("#ifsc").val();
    var addProof = $("#addProof").val();
    var idProof = $("#idProof").val();

  
  $.ajax({
    url: "function_agent/update_agent.php",
    type: "post",
    data: {
      fname:fname,
      lname:lname,
...
<p class="h3">Personal Details</p>
    ...
    <div class="form-group">
      <div class = "col-sm-4"> <input type="email" class="form-control" id="email" placeholder="Enter email" value = "<?php echo $email ?>" name="email"></div>
      <div class="col-sm-4">
        <input type="number" class="form-control" id="mobile_no" placeholder="Enter Mobile No" value = "<?php echo $mobile_no ?>" name="mobile_no">
      </div>
    </div>
...
<div class="form-group buttongroup pull-right">
  
   
      
      <div class = "">
         <center>
        <button type = "button" class = "btn btn-lg " id = "changefield"><span>Modify The Details</span></button> 
        <button type = "button" class = "btn btn-lg " id = "uploadfield" onclick="updateDetails()"><span>Update The Changed Details</span></button> 
         </center> 
      </div>
    </div>    
