...
<html>
  ...
  <input type="text" name="search" placeholder="Search..">
      ...
      <div class="content-wrapper">
        ...
        <div class="container-fluid" style="margin:20px;">
         ...
         <h3>Workshops Attended</h3>
            <?php
    $sql = "SELECT * from workshop_attended";
	$result = mysqli_query($db_connect,$sql);
                      $ctr=10;
                      echo ' <table class="table table-striped"><thead>
    <th>'.'Name'.'</th><th>'.'Venue'.'</th><th>'.'Time'.'</th><th>'.'Date'.'</th><th>'.'Duration'.'</th><th>'.'TECQIP'.'</th><th>'.'Organised by'.'</th></thead>';
	while(($row = $result->fetch_assoc()) && $ctr > 0)
	{
        ...
        echo '<td>'.$row['TECQIP'].'</td>';
        echo '<td>'.$row['Organised_by'].'</td></tr>';
        
        
	}
                      echo '</table>';
?>
            <h3>Workshop Conducted</h3>
            <?php
    $sql = "SELECT * from workshop_conducted";
	$result = mysqli_query($db_connect,$sql);
                      $ctr=10;
                      echo ' <table class="table table-striped"><thead>
    <th>'.'Name'.'</th><th>'.'Venue'.'</th><th>'.'Time'.'</th><th>'.'Date'.'</th><th>'.'Duration'.'</th><th>'.'TECQIP'.'</th><th>'.'Organised by'.'</th></thead>';
