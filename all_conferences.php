      ...
      <div class="content-wrapper">
        ...
        <div class="container-fluid" style="margin:20px;">
         ...
         <h3>Conferences Attended</h3>
            <?php
    $sql = "SELECT * from conference_attended";
	$result = mysqli_query($db_connect,$sql);
                      $ctr=10;
                      echo ' <table class="table table-striped"><thead>
    <th>'.'Name'.'</th><th>'.'Venue'.'</th><th>'.'Time'.'</th><th>'.'Date'.'</th><th>'.'Duration'.'</th><th>'.'Organised By'.'</th></thead>';
	while(($row = $result->fetch_assoc()) && $ctr > 0)
	{
        ...
        echo '<td>'.$row['Duration'].'</td>';
         echo '<td>'.$row['Organised_by'].'</td>';
                      ...
                      echo '</table>';
?>
            <h3>Conferences Organised</h3>
            <?php
    $sql = "SELECT * from conference_organised";
	$result = mysqli_query($db_connect,$sql);
                      $ctr=10;
                      echo ' <table class="table table-striped"><thead>
    <th>'.'Name'.'</th><th>'.'Venue'.'</th><th>'.'Time'.'</th><th>'.'Date'.'</th><th>'.'Duration'.'</th><th>'.'Resource Person'.'</th></thead>';
	while(($row = $result->fetch_assoc()) && $ctr > 0)
	{
        $ctr--;
